...
#endif
typedef struct { int8_T kvcfdv4d00 ; } B ; typedef struct { struct { void *
LoggedData ; } fbsrkyclbh ; } DW ; typedef struct { rtwCAPI_ModelMappingInfo
mmi ; } DataMapInfo ; struct P_ { real_T WaveformGenerator_SelectedSignal ; }
