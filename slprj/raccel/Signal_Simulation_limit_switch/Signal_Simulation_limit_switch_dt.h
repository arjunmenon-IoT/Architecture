...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . a5kyfxk4xe ) , 0 , 0 , 2 } ,
{ ( char_T * ) ( & rtB . fgayencn5l ) , 3 , 0 , 2 } , { ( char_T * ) ( & rtDW
. jieqrkgmgu . LoggedData [ 0 ] ) , 11 , 0 , 3 } , { ( char_T * ) ( & rtDW .
fwwy0hicqa ) , 3 , 0 , 1 } } ; static DataTypeTransitionTable rtBTransTable =
{ 4U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . RepeatingSequenceStair_OutValues [ 0 ] ) , 0 , 0 , 7 }
, { ( char_T * ) ( & rtP . LimitedCounter_uplimit ) , 3 , 0 , 1 } , { (
char_T * ) ( & rtP . LookUpTable1_bp01Data [ 0 ] ) , 0 , 0 , 3 } , { ( char_T
* ) ( & rtP . Output_InitialCondition ) , 3 , 0 , 3 } } ; static
